...
#bwa samse -f results/${FILE_NAME}_${PRE_REF}.sam -r "@RG\tID:${ID}\tLB:${LB}\tSM:${SM}\tPL:${PL}\tCN:${CN}\tPU:${PU}"  genome/${PRE_REF} results/${FILE_NAME}_${PRE_REF}.sai rawdata/${FILE_NAME}.fastq.gz | tee -a logs/log_${FILE_NAME}_${PRE_REF}_${fecha}.log



#samtools view -bS  results/${FILE_NAME}_${PRE_REF}.sam | samtools sort - results/${FILE_NAME}_${PRE_REF}.sam.sorted | tee -a logs/log_${FILE_NAME}_${PRE_REF}_${fecha}.log
...
samtools view -b -q 30 results/${FILE_NAME}_${PRE_REF}.sam.sorted.noDup.bam | samtools sort - results/${FILE_NAME}_${PRE_REF}.sam.sorted.noDup.q30 | tee -a logs/log_${FILE_NAME}_${PRE_REF}_${fecha}.log

samtools index results/${FILE_NAME}_${PRE_REF}.sam.sorted.noDup.q30.bam | tee -a logs/log_${FILE_NAME}_${PRE_REF}_${fecha}.log
